...
import {ReponseHttp} from '../../../application/errors/enum.responseError';
import { UpdateUserDto } from "../../../application/dto/user/updateUser.fto";
import { plainToClass } from "class-transformer";


export const ValidateDtoUpdateUser= (req: Request, res: Response, next: NextFunction)=>{
