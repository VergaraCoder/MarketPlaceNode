...
export class ControllerProduct{
    ...
    public static async findOneProduct(req:Request,res:Response,next:NextFunction){
        try{
            const productService:ProductService=container.resolve(ProductService);
            const product:Product= await productService.getOneProductById(parseInt(req.params["idProduct"]));
            res.json({
    ...
    public static async updateProduct(req:Request,res:Response,next:NextFunction){
        try{
            const productService:ProductService=container.resolve(ProductService);
            const product:boolean= await productService.updateProduct(parseInt(req.params["id"]),req.body);
            res.json({
    ...
    public static async deleteProduct(req:Request,res:Response,next:NextFunction){
        try{
            const productService:ProductService=container.resolve(ProductService);
            const product:boolean= await productService.deleteProduct(parseInt(req.params["id"]));
            res.json({
