 ...
 *                      $ref: '#/components/examples/ExampleError500'
 */
routes.get('/roles/:idRole', RolesController.findOneRoles)
 ...
 *                      $ref: '#/components/examples/ExampleError500'
 */
routes.patch('/roles/:idRole', RolesController.updateRoles)
 ...
 *                      $ref: '#/components/examples/ExampleError500'
 */
routes.delete('/roles/:idRole', RolesController.deleteRoles)
